...
(function($) {
    ...
    $(".journey-day-name").html(journeyDate.toLocaleString('en-us', {
        weekday: 'long'
    }));
    $(".return-day-name").html(returnDate.toLocaleString('en-us', {
        weekday: 'long'
    }));

    $(".journey-date").change(function() {
        var ojd = $(this).closest(".search-form-date").find(".journey-date").val();
        const journeyDayName = new Date(ojd).toLocaleString('en-us', {
            weekday: 'long'
        });
    ...
    $(".return-date").change(function() {
        ...
        const returnDayName = new Date(rd).toLocaleString('en-us', {
            weekday: 'long'
        });
